...
namespace Samueletur\GalaxPay\Sessions;

use Samueletur\GalaxPay\Abstracts\Session;
use Samueletur\GalaxPay\Contracts\Session as ContractsSession;
...
class Database extends Session implements ContractsSession
{
    ...
    public function updateOrCreate($clientGalaxId, $values = []): void
    {
        ...
        /** @var \Samueletur\GalaxPay\Models\GalaxPaySession */
    ...
    /** 
     * @return \Samueletur\GalaxPay\Models\GalaxPayClient 
     */
