...
use Samueletur\GalaxPay\Http\Auth;
use Samueletur\GalaxPay\Http\Config;
use Samueletur\GalaxPay\Exceptions\AuthorizationException;
use Samueletur\GalaxPay\QueryParams;
...
final class Api
{
     ...
     * 
     * @var \Samueletur\GalaxPay\Http\Auth
     */
    private $auth;
     ...
     * 
     * @param \Samueletur\GalaxPay\Http\Config|null $config
     * @return void
     */
